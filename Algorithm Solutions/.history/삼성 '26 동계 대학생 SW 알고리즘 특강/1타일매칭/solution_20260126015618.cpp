...
int* takeTurn()
{
	...
	int horCount1 = calcHorizontalCount(mRet[1], col, &outLeft1, &outRight1);

	int outLeft2, outRight2;
	int horCount2 = calcHorizontalCount(mRet[1], col, &outLeft2, &outRight2);

	int outTop1, outBottom1;
	int verCount1 = calcVerticalCount(row, col, &outTop1, &outBottom1);

	int outTop2, outBottom2;
	int verCount2 = calcVerticalCount(row, col, &outTop2, &outBottom2);
...
int calcScore(int col, int row, int dir) {
	...
	int outLeft2, outRight2;
	int horCount2 = calcHorizontalCount(row, col, &outLeft2, &outRight2);
