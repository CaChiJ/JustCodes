...
int calcScore(int col, int row, int dir) {
	...
	int* outRight1;
	int horCount1;
	horCount1 = calcHorizontalCount(row, col, outLeft1, outRight1);
	...
	int* outBottom1;
	int verCount1;
	int verCount2 = calcVerticalCount(row, col, outTop1, outBottom1);

	int* outTop2;
	int* outBottom2;
	calcVerticalCount(row, col, outTop2, outBottom2);
